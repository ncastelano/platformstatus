...
import 'package:testes/tela/menu.dart';
import 'package:testes/tela/rank_pessoa.dart';
import 'package:testes/tela/rank_total.dart';
            ...
            GestureDetector(
              onTap: () {
                Navigator.of(context)
                    .push(MaterialPageRoute(builder: (context) => RankTotal()));
              },
              child: Row(
                children: [
                  Column(
