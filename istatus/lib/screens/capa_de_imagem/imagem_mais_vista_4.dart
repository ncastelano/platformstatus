...
class ImagemMaisVista4 extends StatefulWidget {
  @override
  _ImagemMaisVista4State createState() => _ImagemMaisVista4State();
}

class _ImagemMaisVista4State extends State<ImagemMaisVista4> {
  @override
