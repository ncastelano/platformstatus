...
import 'package:istatus/screens/telas_iniciais/rank_radio_diario.dart';
import 'package:istatus/screens/telas_iniciais/rank_radio_semana.dart';

import '../componentes/menu.dart';

class TelaRadio extends StatefulWidget {
  @override
  _TelaRadioState createState() => _TelaRadioState();
}

class _TelaRadioState extends State<TelaRadio> {
          ...
          children: <Widget>[
            ...
            ClipRect(
              child: GestureDetector(
                onTap: () {
                  Navigator.of(context).push(
                      MaterialPageRoute(builder: (context) => RankRadiodiario()));
                },
                child: Row(
                  children: <Widget>[
                    Container(
            ...
            GestureDetector(
              onTap: () {
                Navigator.of(context)
                    .push(MaterialPageRoute(builder: (context) => RankRadiosemana()));
              },
              child: Row(
                children: [
                  Column(
