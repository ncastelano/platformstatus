...
import 'package:istatus/screens/telas_iniciais/rank_video_diario.dart';
import 'package:istatus/screens/telas_iniciais/rank_video_semana.dart';
          ...
          children: <Widget>[
            ...
            ClipRect(
              child: GestureDetector(
                onTap: () {
                  Navigator.of(context).push(
                      MaterialPageRoute(builder: (context) => RankVideodiario()));
                },
                child: Row(
                  children: <Widget>[
                    Container(
            ...
            GestureDetector(
              onTap: () {
                Navigator.of(context)
                    .push(MaterialPageRoute(builder: (context) => RankVideosemana()));
              },
              child: Row(
                children: [
                  Column(
