...
class TelaDinheiro extends StatefulWidget {
  @override
  _TelaDinheiroState createState() => _TelaDinheiroState();
}

class _TelaDinheiroState extends State<TelaDinheiro> {
        ...
        child: Column(
          children: <Widget>[
            ...
            Container(
              ...
              child: Text('pessoas que recebo ou pago'),
            )
          ],
        ),
      ),
